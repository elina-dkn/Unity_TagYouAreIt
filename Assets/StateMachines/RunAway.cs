...
[Serializable]
public class RunAway : FSMC_Behaviour
{
    ...
    {
        m_go.GetComponent<Renderer>().material.SetColor("_Color", Color.yellow);
    ...
    public override void OnStateUpdate(FSMC_Controller stateMachine, FSMC_Executer executer)
    {
        ...
        m_go.transform.position += (m_go.transform.position - m_player.transform.position).normalized * m_speed * Time.deltaTime;
